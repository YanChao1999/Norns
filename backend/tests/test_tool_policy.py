...
def test_write_tool_detection():
    ...
    assert is_write_tool("sandbox_run")
    assert is_write_tool("sandbox_write_file")
    assert is_write_tool("sandbox_copy_in")
    assert not is_write_tool("sandbox_info")
    assert not is_write_tool("sandbox_list")
    assert not is_write_tool("sandbox_read_file")
