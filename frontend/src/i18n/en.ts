...
export const en = {
  ...
  'detail.bakeoffStarting': 'Starting…',
  'detail.bakeoffLoading': 'Loading bakeoff…',
  'detail.bakeoffError': 'Could not start bakeoff. Card must be idle, and arms need distinct labels.',
  'detail.bakeoffPrompt': 'Shared prompt (optional — defaults to card body)',
  'detail.bakeoffPromptPlaceholder': 'Same test for every arm…',
  'detail.bakeoffArmLabel': 'Arm label',
  'detail.bakeoffTools': 'Tools',
  'detail.bakeoffToolsEmpty': 'none (empty allowlist)',
  'detail.bakeoffArm': 'Arm',
  'detail.bakeoffOutcome': 'Outcome',
  'detail.bakeoffFamilyTotal': 'Bakeoff total tokens',
  'detail.bakeoffStatus': 'Bakeoff · {status}',
