  ...
  return (
    <Dialog open onClose={onClose} labelledBy="agent-config-title" variant="modal">
      ...
      <div className="field">
        ...
        <p className="muted">
          Enable norns (cards, stages, prompts, git workspace), sandbox (reproduce / env-build: run commands in
          the jail, read/write the copy), github, jira, polarion, or an MCP connector from Settings. Cursor stages
          receive these as MCP
